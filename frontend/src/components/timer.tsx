...
export function Timer({
  ...
  return (
    <div className="flex w-md my-0 opacity-80 flex-col">
      <div className="flex flex-1 flex-row">
        <Button
          variant={currentMode == "pomodoro" ? "outline" : "ghost"}
        ...
        <Button
          className={`${
           ...
           px-0 h-6 text-xs  rounded-none`}
          variant={currentMode == "shortbreak" ? "outline" : "ghost"}
        ...
        <Button
          ...
          variant={currentMode == "longbreak" ? "outline" : "ghost"}
      ...
      <div className="flex flex-6 flex-row">
        ...
        <h1 className="flex-1 bg-accent m-auto px-5 font-bold text-3xl">
